...
/** Start, restart, or resume a source, setting its state to AL_PLAYING. */
AL_API void AL_APIENTRY alSourcePlay(ALuint source) AL_API_NOEXCEPT;
/** Close a source, setting its state to AL_STOPPED if playing or paused. */
